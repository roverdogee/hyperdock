...
enum Design {
    ...
    static let titleFocusedFont = Font.system(size: 12, weight: .medium)
    static let appNameFont = Font.system(size: 11, weight: .medium)
    static let badgeFont = Font.system(size: 10, weight: .semibold)

    // MARK: Motion

    static let appear = Animation.spring(response: 0.18, dampingFraction: 0.78)
    static let focus = Animation.easeOut(duration: 0.12)
